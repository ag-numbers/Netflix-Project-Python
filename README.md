...
I performed exploratory data analysis on the netflix_data.csv data to understand more about movies from the 1990s decade, specifically: 
What was the most frequent movie duration in the 1990s? 
Answer: 100 min
What is the number of short action movies released in the 1990s? 
Answer: 7
